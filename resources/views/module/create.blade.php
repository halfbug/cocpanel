...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <!--<button id="btn_add" name="btn_add_module" class="btn btn-default pull-right"></button>-->
             <a href="{{ url('modules/add') }}" class="btn btn-default pull-right">Add New Module</a>
