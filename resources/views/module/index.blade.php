...
<!--                                        <td>{{$module->id}}</td>-->
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-warning " value="{{$module->id}}"  title="Questions"><i class="fa fa-question-circle"></i></button>
                                            |
                                            <button class="btn btn-success " value="{{$module->id}}" title="Make Live"><i class="fa fa-plus-square-o" ></i></button>
